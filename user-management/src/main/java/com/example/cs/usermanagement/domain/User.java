...
public class User {
    ...
    private User(UUID id, String username, String name, String surname, boolean isDebtor, boolean isDeleted) {
        this.id = id;
    ...
    public static User reconstitute(UUID id, String username, String name, String surname, boolean isDebtor, boolean isDeleted) {
